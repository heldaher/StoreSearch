...
//  StoreSearch
//
//  Created by Henri El Daher on 8/2/17.
            ...
            UIView.animateKeyframes(withDuration: transitionDuration(using: transitionContext),
                                    ...
                                    animations: {UIView.addKeyframe(withRelativeStartTime: 0.0,
                                        ...
                                        UIView.addKeyframe(withRelativeStartTime: 0.334,
                                                           ...
                                                           animations: {toView.transform = CGAffineTransform(scaleX: 0.9, y: 0.9)})
                                        UIView.addKeyframe(withRelativeStartTime: 0.666,
                                                           relativeDuration: 0.333,
                                                           animations: {toView.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)})
            },
